...
import { DocumentExports, exportPaths } from '../../src/exports'
import { embedExportImages } from '../../src/export-resources'
import type { ExtensionMessage } from '../src/vscode-protocol'

vi.mock('../../src/export-browser', () => ({ browserExecutable: vi.fn(), exportWithBrowser: vi.fn() }))
