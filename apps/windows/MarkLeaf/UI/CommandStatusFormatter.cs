...
internal static class CommandStatusFormatter
{
    ...
    private static string GetDisplayName(AppCommand command)
    {
        return command switch
        {
            ...
            AppCommand.GoToFootnoteReference => Loc.Get("cmd.goToFootnoteReference"),
            AppCommand.ClearFootnoteReferences => Loc.Get("cmd.clearFootnoteReferences"),
            AppCommand.DeleteFootnote => Loc.Get("cmd.deleteFootnote"),
