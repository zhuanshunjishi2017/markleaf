...
let noTabs = MenuCommandAvailabilityState(tabCount: 0, activeTabPath: nil, workspaceRoot: nil)
let untitled = MenuCommandAvailabilityState(tabCount: 1, activeTabPath: nil, workspaceRoot: nil)
