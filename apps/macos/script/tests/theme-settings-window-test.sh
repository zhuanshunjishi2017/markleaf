...
DEVELOPER_DIR=/Applications/Xcode-beta.app/Contents/Developer CLANG_MODULE_CACHE_PATH="$BUILD/cache" xcrun swiftc "$ROOT/Sources/MarkLeaf/Services/L10n.swift" "$ROOT/Sources/MarkLeaf/Services/OptionalFontCatalog.swift" "$ROOT/Sources/MarkLeaf/Services/OptionalFontInstaller.swift" "$ROOT/Sources/MarkLeaf/Services/CurrentStyleFontNotice.swift" "$ROOT/Sources/MarkLeaf/Services/ThemeIDNormalizer.swift" "$ROOT/Sources/MarkLeaf/Services/StyleManager.swift" "$ROOT/Sources/MarkLeaf/Services/ThemeSettingsModel.swift" "$ROOT/Sources/MarkLeaf/Views/ThemeSettingsWindowController.swift" "$BUILD/main.swift" -o "$BUILD/test"
"$BUILD/test"
