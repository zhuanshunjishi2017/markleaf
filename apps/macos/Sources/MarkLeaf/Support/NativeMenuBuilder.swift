...
final class NativeMenuBuilder {
    ...
    private func fileMenu() -> NSMenu {
        ...
        menu.addItem(commandItem(L10n.t("导出 PDF…"), "exportPdf", key: "e", mask: [.command, .shift]))
        menu.addItem(commandItem(L10n.t("导出 HTML…"), "exportHtml"))
...
extension EditorSession {
    ...
    func performMenuCommand(_ command: String) {
        ...
        case "exportPdf": exportPDFDocument()
        case "exportHtml": exportHTMLDocument()
