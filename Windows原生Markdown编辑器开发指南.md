...
- 定义模式切换和撤销行为。
- 实现多标签文档，早期优先使用标准 `TabControl`。

完成条件：

- 查找替换在复杂文档中准确。
- 模式切换不丢失内容。
- 多文档 revision 和保存状态相互隔离。

阶段验证：

- 编译和自动测试。
- 测试模式切换、解析失败、多标签保存和关闭确认。
- 暂停等待开发者检查多文档工作流。
...
![屏幕截图 2026-07-30 232204](Windows原生Markdown编辑器开发指南.assets/屏幕截图 2026-07-30 232204-3.png)
