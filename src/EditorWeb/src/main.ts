...
editorMount.addEventListener('markleaf-block-handle', (event) => {
  ...
  if (!sourceMode) setBlockHighlight(editor, typeof detail.position === 'number' ? detail.position : null)
  send('blockMenuRequested', detail)
})
