...
internal sealed class AboutDialog : Form
{
    ...
    public AboutDialog(string? gitHubDisplayName)
    {
        Text = "关于 MarkLeaf";
        ...
        var author = RepoOwner;
        if (!string.IsNullOrWhiteSpace(gitHubDisplayName) && gitHubDisplayName != RepoOwner)
        {
            author = $"{gitHubDisplayName} ({RepoOwner})";
        }

        infoPanel.Controls.Add(NewLabel($"作者： {author}"), 0, 6);
